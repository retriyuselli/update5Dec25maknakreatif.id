                            ...
                            Select::make('nota_dinas_detail_id')
                                ...
                                ->options(function (callable $get) {
                                    ...
                                    try {
                                        ...
                                        $usedDetailIds = ExpenseOps::whereNotNull('nota_dinas_detail_id')
                    ...
                    Grid::make(4)
                        ->schema([
                            ...
                            DatePicker::make('tanggal_transfer')
                                ...
                                ->default(now())
                                ->required()
                                ->helperText(new HtmlString('<span style="color: #3b82f6; font-size: 12px;">Sesuaikan tanggal transfer</span>'))
                                ->columnSpan(1),
                        ]),
                    ...
                    Grid::make(3)
                        ->schema([
                            Select::make('payment_method_id')
                                ...
                                ->searchable()
                                ->preload()
                                ->helperText(new HtmlString('<span style="color: #3b82f6; font-size: 12px;">Sesuaikan rekening transfer</span>'))
                                ->required()
                                ->columnSpan(1),
